@testset "Generation tools" begin
    ...
    @test NDTools.dim_to_idx(opt_cu([1 2; 3 4]), Val(2)) ==  opt_cu([(1, 2), (3, 4)])

    @test NDTools.dim_to_idx(opt_cu([1 2 2; 3 4 2;;;5 6 2;7 8 2]), Val(2)) == opt_cu([(1, 5)  (2, 6)  (2, 2); (3, 7)  (4, 8)  (2, 2)])
