@testset "Generation tools" begin
    ...
    @test dim_to_idx(opt_cu([1 2; 3 4])) ==  opt_cu([(1, 2), (3, 4)])
    
    @test dim_to_idx(opt_cu([1 2 2; 3 4 2;;;5 6 2;7 8 2])) == opt_cu([(1, 5)  (2, 6)  (2, 2); (3, 7)  (4, 8)  (2, 2)])

    @test idx_to_arr_view(opt_cu([(1, 2) (3, 4); (5, 6) (7, 8)])) == opt_cu([1 5; 2 6;;; 3 7;4 8])
